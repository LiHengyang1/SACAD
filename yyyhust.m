...
useCUDA = 1;
useLBFGS = 0;
useWholePolarization = 1;

if useWholePolarization == 1
    [Jax,Jay,Jaz,Q3d,ap] = Fx_coefficient_environment_xyz(0.1782,100e-3);
else
    [Jax,Q3d,ap] = Fx_coefficient_environment(0.1782,70e-3);
end
...
if useLBFGS == 1
    ...
    matlab_options = optimoptions('fmincon','GradObj','on', 'display', 'iter', ...
        'algorithm','interior-point','HessianApproximation','lbfgs', 'MaxFunEvals', 1000, 'MaxIterations', 1000,...
